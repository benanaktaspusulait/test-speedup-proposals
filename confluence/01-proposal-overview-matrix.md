...
| Maven parallel reactor | Use Maven `-T` for independent modules | Low | Low | Low | Low | Could | Assess per module graph; gain is small unless early modules overlap significantly |
